...
export const newsArticles: CMSNewsArticle[] = [
  {
    id: "news-001",
    slug: "cs-researchers-breakthrough-protein-folding",
    title:
      "CS Researchers Achieve Breakthrough in Real-Time Protein Folding Prediction",
    summary:
    ...
    body: {
      html: `<p>In a paper published today in Nature Methods, a team from the Computer Science and Structural Biology departments has unveiled ProteinFormer, a specialized transformer model that achieves state-of-the-art accuracy in protein structure prediction while running fast enough for interactive use.</p>
...
<p>The team has released ProteinFormer as open-source software, along with pre-trained weights and an interactive web interface that allows biologists to submit sequences and receive structural predictions in real time.</p>`,
    ...
    category: "research",
    publishedAt: "2024-07-25T06:00:00Z",
    featured: true,
  },
  {
    id: "news-002",
    ...
    body: {
      html: `<p>Professor Luis Martinez, the Distinguished Professor of Computer Science, has been elected to the National Academy of Engineering (NAE), one of the highest professional distinctions for engineers.</p>
<p>Martinez was cited for "fundamental contributions to the theory and practice of distributed consensus, enabling the reliable distributed systems that underpin modern cloud computing." His work on the Raft consensus algorithm has become the standard implementation in systems from Kubernetes to CockroachDB.</p>
...
<p>Martinez joins 18 current faculty members in the NAE. He is the third member of the Computer Science department to be elected in the last five years.</p>`,
    },
    image: {
    ...
    authorRole: "School of Engineering",
    category: "faculty",
  ...
  },
  {
    ...
    title: "Three PhD Students Win Best Paper Award at SOSP 2024",
    summary:
...
<p>"This is a testament to the incredible depth of systems research happening in our department," said their advisor, Professor Martinez. "These students are tackling problems that will define the next generation of computing infrastructure."</p>`,
  ...
  },
  {
    ...
    title:
      "University Launches Center for Responsible AI with $50M Founding Gift",
    summary:
    ...
    body: {
      html: `<p>The university today announced the establishment of the Center for Responsible AI (CRAI), a new interdisciplinary research center funded by a $50 million founding gift from the Marshall Foundation.</p>
...
<p>The center's initial research agenda includes AI safety in healthcare, algorithmic fairness in criminal justice, environmental impact of large-scale AI training, and governance frameworks for frontier AI models.</p>`,
    ...
    authorRole: "University News Service",
  ...
  },
  {
    ...
    title:
      "Undergraduate Team Advances to ICPC World Finals for Fifth Consecutive Year",
    summary:
      "The three-person team solved 11 of 13 problems to win the North America Pacific Northwest Regional, securing a spot at the 2024 World Finals in Shenzhen.",
    body: {
      html: `<p>The university's competitive programming team, consisting of sophomores David Park and Priya Sharma and junior Alex Gonzalez, dominated the ICPC North America Pacific Northwest Regional Contest, solving 11 of 13 problems in under four hours to claim first place and a berth at the World Finals.</p>
...
<p>The World Finals will be held in Shenzhen, China, in June 2024, where the team will compete against approximately 130 teams from around the world. The team's best World Finals finish was 4th place in 2022.</p>`,
    },
    image: {
      url: "/images/icpc-team.jpg",
      alt: "Three undergraduate students in university t-shirts celebrating with laptops",
      width: 1200,
      height: 630,
    },
    ...
    category: "students",
    publishedAt: "2024-07-12T16:00:00Z",
    featured: false,
  },
  {
    id: "news-006",
    slug: "nsf-career-awards-2024",
...
<p>"These awards reflect the exceptional quality of our junior faculty cohort," said Department Chair Professor Linda Nakamura. "Each of these researchers is pushing the boundaries of their field while being extraordinary educators and mentors."</p>`,
    },
    image: {
      url: "/images/nsf-career.jpg",
      alt: "Four faculty members posing together in front of the Computer Science building",
      width: 1200,
      height: 630,
    },
    author: "Communications Staff",
    authorRole: "School of Engineering",
    category: "awards",
    publishedAt: "2024-07-08T09:00:00Z",
    featured: false,
  },
  {
    id: "news-007",
    ...
    body: {
      html: `<p>The Computer Science department and NASA's Jet Propulsion Laboratory (JPL) have signed a five-year cooperative research agreement focused on developing autonomous systems for deep-space exploration.</p>
...
<p>"When a spacecraft is exploring the moons of Jupiter, a round-trip signal takes over an hour," explained Professor Robert Chang, the principal investigator. "The spacecraft must be capable of making complex decisions entirely on its own. That's an AI problem of extraordinary difficulty and consequence."</p>
<p>The first cohort of four PhD students will begin at JPL this summer, working alongside JPL engineers on simulation environments for the upcoming Europa Clipper mission.</p>`,
  ...
  {
    id: "news-008",
    slug: "cs-department-diversity-report-2023",
    title:
      "CS Department Releases 2023 Diversity & Inclusion Progress Report",
    summary:
