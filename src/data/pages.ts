...
export const pages: CMSPage[] = [
  {
    ...
    body: {
      html: `<p>The Stanford Computer Science Department is one of the premier computer science programs in the world, consistently ranked among the top departments globally. Founded in 1965, the department has been at the forefront of transformative advances in computing, from the development of ARPANET to the creation of foundational technologies in artificial intelligence, networking, databases, and programming languages.</p>
...
<h2>Our Community</h2>
<p>What sets Stanford CS apart is not just the quality of our research but the collaborative, supportive community we've built. Our students regularly co-author papers with faculty from other departments and collaborate with researchers at Stanford's interdisciplinary institutes, including the Stanford Institute for Human-Centered AI (HAI), the Bio-X program, and the Woods Institute for the Environment.</p>
...
<h2>Location</h2>
<p>The department is primarily located in the Gates Computer Science Building and the Allen Building for Integrated Systems, situated at the heart of Stanford's engineering quad. Our facilities include state-of-the-art research labs, collaborative workspaces, and teaching facilities designed to foster creativity and innovation.</p>`,
    },
    image: {
      url: "/images/gates-building.jpg",
      alt: "The Gates Computer Science Building at Stanford University, a modern sandstone building with palm trees",
      width: 1200,
      height: 630,
    },
  },
  {
    ...
    body: {
      html: `<p>The Stanford Computer Science Department is a world leader in research and education, pioneering advances across artificial intelligence, systems, theory, and interdisciplinary computing. Our community of exceptional scholars, students, and staff works together to solve the most important challenges of our time.</p>`,
    },
    image: {
      url: "/images/stanford-campus.jpg",
      alt: "Aerial view of Stanford University campus with the Hoover Tower and surrounding buildings",
      width: 1920,
      height: 600,
    },
  },
